...
//  
//
//  Created by Lawrence Bensaid on 3/24/22.
//
...
public extension String {
    ...
    static func random(_ type: RandomStringType, delimiter: String = " ") -> String {
        ...
        case .humanName:
            return "\(menFirstNames.randomElement()!)\(delimiter)\(lastNames.randomElement()!)"
        case .manName:
            return "\(menFirstNames.randomElement()!)\(delimiter)\(lastNames.randomElement()!)"
        case .womanName:
            return "\(womanFirstNames.randomElement()!)\(delimiter)\(lastNames.randomElement()!)"
        case .distinguished:
            let name = "\(adjectives.randomElement()!)\(delimiter)\(significantPeopleLastnames.randomElement()!)"
            if name == "Boring\(delimiter)Wozniak" {
                print("Steve Wozniak isn't boring!")
                return random(type, delimiter: delimiter)
            }
        case .default: break
        }
...
fileprivate let noun = [
    "Air", "Area", "Art", "Back", "Body", "Book", "Brother", "Business", "Car", "Case", "Change", "Child", "City", "Community", "Company", "Country", "Day", "Door", "Education", "Encore", "End", "Eye", "Face", "Fact", "Family", "Father", "Force", "Friend", "Game", "Girl", "Government", "Group", "Guy", "Hand", "Head", "Health", "History", "Home", "Hour", "House", "Idea", "Information", "Issue", "Job", "Kid", "Kind", "Law", "Level", "Life", "Line", "Lot", "Man", "Member", "Minute", "Moment", "Money", "Month", "Morning", "Mother", "Name", "Night", "Number", "Office", "Parent", "Part", "Party", "People", "Person", "Place", "Point", "Power", "President", "Problem", "Program", "Question", "Reason", "Research", "Result", "Right", "Room", "School", "Service", "Side", "State", "Story", "Student", "Study", "System", "Teacher", "Team", "Thing", "Time", "War", "Water", "Way", "Week", "Woman", "Word", "Work", "World", "Year"]


fileprivate let womanFirstNames = [
    "Alice", "Amber", "Amelia", "Amy", "Andrea", "Angela", "Anna", "Annabelle", "Antonia", "April", "Ashley", "Audrey", "Ava", "Barbara", "Bella", "Bernadette", "Beth", "Beverly", "Bonnie", "Brittany", "Caroline", "Carrie", "Catherine", "Charlotte", "Chloe", "Christina", "Claire", "Claudia", "Colleen", "Connie", "Constance", "Cora", "Cynthia", "Daisy", "Dana", "Danielle", "Deborah", "Delia", "Diana", "Diane", "Dominique", "Dorothy", "Edith", "Eleanor", "Elizabeth", "Ella", "Ellen", "Emily", "Emma", "Erika", "Esther", "Eve", "Faith", "Fiona", "Frances", "Francesca", "Gabriela", "Georgia", "Gillian", "Grace", "Hannah", "Harriet", "Heather", "Holly", "Irene", "Isabel", "Isabella", "Isabelle", "Jacqueline", "Jane", "Janet", "Jennifer", "Jessica", "Joan", "Joanne", "Julia", "Julie", "Karen", "Katherine", "Kathleen", "Kathy", "Katie", "Kayla", "Kelly", "Kimberly", "Kylie", "Laura", "Lauren", "Leah", "Lillian", "Lily", "Linda", "Lisa", "Liz", "Lola", "Lorraine", "Louise", "Lucy", "Lydia", "Mackenzie", "Madeleine", "Maggie", "Mandy", "Margaret", "Maria", "Martha", "Mary", "Megan", "Melanie", "Melissa", "Michelle", "Molly", "Nancy", "Naomi", "Nicole", "Olivia", "Patricia", "Paula", "Penny", "Rachel", "Rebecca", "Rita", "Rose", "Ruth", "Sally", "Samantha", "Sandra", "Sarah", "Sasha", "Samantha", "Sara", "Tanya", "Teresa", "Theresa", "Tiffany", "Tracy", "Valerie", "Vanessa", "Victoria", "Virginia", "Wendy", "Xaviera", "Yvonne", "Zoe"
]

fileprivate let menFirstNames = [
    "Lawrence", "Steve", "Einstein"
]

fileprivate let lastNames = [
    "Anderson", "Baker", "Brown", "Campbell", "Carter", "Clark", "Collins", "Davis", "Edwards", "Evans", "Garcia", "Gonzalez", "Green", "Hall", "Harris", "Hill", "Jackson", "James", "Jenkins", "Johnson", "Jones", "Kelly", "King", "Lee", "Lewis", "Long", "Martin", "Martinez", "Miller", "Mitchell", "Moore", "Morgan", "Morris", "Murphy", "Myers", "Nelson", "Parker", "Perez", "Phillips", "Roberts", "Robinson", "Rodriguez", "Scott", "Smith", "Stewart", "Taylor", "Thomas", "Thompson", "Turner", "Walker", "White", "Williams", "Wilson", "Wright", "Young"
]

fileprivate let significantPeopleLastnames = [
